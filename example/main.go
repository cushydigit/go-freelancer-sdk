...
func ListProjects() {
	// create projects list service
	s := client.NewProjectsListService()
...
func ListTimezones() {
	s := client.NewTimezonesListService()
	resp, err := s.Do(context.Background())
	if err != nil {
		log.Printf("error: %v", err)
	}
	res := helper.ListTimezonesResponse{}
	b, _ := json.Marshal(resp)
	_ = json.Unmarshal(b, &res)
...
func ListCurrencies() {
	s := client.NewCurrenciesListService()
	resp, err := s.Do(context.Background())
	if err != nil {
		log.Printf("error: %v", err)
	}
	res := helper.ListCurrenciesResponse{}
	b, _ := json.Marshal(resp)
	_ = json.Unmarshal(b, &res)
...
func ListBudgets() {
	s := client.NewBudgetsListService()
	resp, err := s.Do(context.Background())
	if err != nil {
		log.Printf("error: %v", err)
	}
...
func ListCategories() {
	...
	res := helper.ListCategoriesResponse{}
	b, _ := json.Marshal(resp)
	_ = json.Unmarshal(b, &res)
