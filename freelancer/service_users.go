...
func (s *SelfService) ListDevices(ctx context.Context) (*rr.ListSelfDevicesResponse, error) {
...
func (s *SelfJobsService) Add(ctx context.Context, b rr.AddJobsBody) (*rr.RawResponse, error) {
...
func (s *SelfJobsService) Set(ctx context.Context, b rr.SetJobsBody) (*rr.RawResponse, error) {
	p := endpoints.UsersSelfJobs
...
func (s *SelfJobsService) Delete(ctx context.Context, b rr.DeleteJobsBody) (*rr.RawResponse, error) {
	p := endpoints.UsersSelfJobs
...
func (s *ReputationsService) List(ctx context.Context, opts *rr.ListReputationsOptions) (*rr.ListUsersReputationsResponse, error) {
...
func (s *EnterprisesService) List(ctx context.Context, opts *rr.ListEnterprisesOptions) (*rr.RawResponse, error) {
...
func (s *PortfoliosService) List(ctx context.Context, opts *rr.ListPortfoliosOptions) (*rr.ListUsersPortfoliosResponse, error) {
...
func (s *ViolationsService) Create(ctx context.Context, b rr.CreateViolationBody) (*rr.RawResponse, error) {
...
func (s *PoolsService) List(ctx context.Context, opts *rr.ListPoolsOptions) (*rr.RawResponse, error) {
