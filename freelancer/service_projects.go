...
func (s *ProjectsService) Create(ctx context.Context, b rr.CreateProjectBody) (*rr.CreateProjectResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) Action(ctx context.Context, projectID int64, action rr.ActionProjectBody) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) List(ctx context.Context, opts *rr.ListProjectsOptions) (*rr.ListProjectsResponse, *ResponseMeta, error) {
	p := endpoints.Projects
	q := query.Values(opts)
...
func (s *ProjectsService) ListSelf(ctx context.Context, opts *rr.ListSelfProjectsOptions) (*rr.ListProjectsResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) Get(ctx context.Context, projectID int64, opts *rr.GetProjectOptions) (*rr.GetProjectResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d", endpoints.Projects, projectID)
	q := query.Values(opts)
...
func (s *ProjectsService) SearchActive(ctx context.Context, opts *rr.SearchActiveProjectsOptions) (*rr.ListProjectsResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) SearchAll(ctx context.Context, opts *rr.SearchAllProjectsOptions) (*rr.ListProjectsResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) InviteFreelancer(ctx context.Context, projectID int64, b rr.InviteFreelancersBody) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) ListUpgradesFees(ctx context.Context, opts *rr.ListUpgradesFeesOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) ListBids(ctx context.Context, projectID int64, opts *rr.ListProjectBidsOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) GetBidInfo(ctx context.Context, projectID int64) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) ListMilestones(ctx context.Context, projectID int64, opts *rr.ListProjectMilestonesOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) ListMilestoneRequests(ctx context.Context, projectID int64, opts *rr.ListProjectsMilestoneRequestsOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) GetHourlyContractInfo(ctx context.Context, opts *rr.GetHourlyContractInfoOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) GetIPContractInfo(ctx context.Context, projectID int64) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ProjectsService) Delete(ctx context.Context, projectID int64) (*rr.RawResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d", endpoints.Projects, projectID)
...
func (s *CollaborationsService) List(ctx context.Context, projectID int64) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *CollaborationsService) Create(ctx context.Context, projectID int64, b rr.CreateCollaborationBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d/collaborations", endpoints.Projects, projectID)
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *CollaborationsService) Action(ctx context.Context, projectID int64, collaborationID int64, b rr.ActionCollaborationBody) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *CollaborationsService) ListAll(ctx context.Context) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ServicesService) Order(ctx context.Context, serviceID int64, serviceType rr.ServiceType) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ServicesService) List(ctx context.Context, opts *rr.ListServicesOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ServicesService) SearchActive(ctx context.Context, opts *rr.SearchActiveServicesOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *BidsService) List(ctx context.Context, opts *rr.ListBidsOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *BidsService) Get(ctx context.Context, bidID int64, opts *rr.GetBidOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *BidsService) Create(ctx context.Context, b rr.CreateBidBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := endpoints.ProjectsBids
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *BidsService) Action(ctx context.Context, bidID int64, b rr.ActionBidBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d", endpoints.ProjectsBids, bidID)
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPut, p, nil, b)
}
...
// It maps to the `PUT` `/projects/0.1/bids/{bid_id}` endpoint
func (s *BidsService) Update(ctx context.Context, bidID int64, b rr.UpdateBidBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d", endpoints.ProjectsBids, bidID)
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPut, p, nil, b)
}
...
func (s *BidsService) GetTimeTracking(ctx context.Context, bidID int64, opts *rr.GetTimeTrackingOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *BidsService) CreateTimeTracking(ctx context.Context, bidID int64, b rr.CreateTimeTrackingBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d/time_tracking", endpoints.ProjectsBids, bidID)
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *BidEditRequestsService) List(ctx context.Context, bidID int64, opts *rr.ListBidEditRequestsOptions) (*rr.ListBidEditRequestsResponse, *ResponseMeta, error) {
...
func (s *BidEditRequestsService) Create(ctx context.Context, b rr.CreateBidEditRequestBody) (*rr.CreateBidEditRequestResponse, *ResponseMeta, error) {
...
func (s *BidEditRequestsService) Action(ctx context.Context, bidID, bidEditRequestID int64, b rr.ActionBidEditRequestBody) (*rr.ActionBidEditRequestResponse, *ResponseMeta, error) {
...
func (s *BidRatingsService) Get(ctx context.Context, bidID int64) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *BidRatingsService) GetByListOfBids(ctx context.Context, opts *rr.GetByListOfBidsOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *BidRatingsService) Create(ctx context.Context, bidID int64, b rr.CreateBidRatingBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d/bid_ratings", endpoints.ProjectsBids, bidID)
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *BidRatingsService) Update(ctx context.Context, bidID int64, bidRatingID int64, b rr.UpdateBidRatingBody) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *JobsService) List(ctx context.Context, opts *rr.ListJobsOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *JobsService) Search(ctx context.Context, opts *rr.SearchJobsOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *JobBundlesService) List(ctx context.Context, opts *rr.ListJobBundlesOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *JobBundleCategoriesService) List(ctx context.Context, opts *rr.ListJobBundleCategoriesOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *MilestonesService) List(ctx context.Context, opts *rr.ListMilestonesOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *MilestonesService) Get(ctx context.Context, milestoneID int64, opts *rr.GetMilestoneOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *MilestonesService) Create(ctx context.Context, b rr.CreateMilestoneBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := endpoints.ProjectsMilestones
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *MilestonesService) Action(ctx context.Context, milestoneID int64, b rr.ActionMilestoneBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d", endpoints.ProjectsMilestones, milestoneID)
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPut, p, nil, b)
}
...
func (s *MilestoneRequestsService) List(ctx context.Context, opts *rr.ListMilestoneRequestsOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *MilestoneRequestsService) Get(ctx context.Context, milestoneRequestID int64, opts *rr.GetMilestoneRequestOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *MilestoneRequestsService) Create(ctx context.Context, b rr.CreateMilestoneRequestBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := endpoints.ProjectsMilestoneRequests
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *MilestoneRequestsService) Action(ctx context.Context, milestoneRequestID int64, b rr.ActionMilestoneRequestBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := fmt.Sprintf("%s/%d", endpoints.ProjectsMilestoneRequests, milestoneRequestID)
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPut, p, nil, b)
}
...
func (s *ReviewsService) List(ctx context.Context, opts *rr.ListReviewsOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ReviewsService) Create(ctx context.Context, b rr.CreateReviewBody) (*rr.RawResponse, *ResponseMeta, error) {
	p := endpoints.ProjectsReviews
	return execute[*rr.RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *ReviewsService) Action(ctx context.Context, reviewID int64, b rr.ActionReviewBody) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ExpertGuaranteesService) List(ctx context.Context, opts *rr.ListExpertGuaranteesOptions) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *ExpertGuaranteesService) Action(ctx context.Context, expertGuaranteesID int64, b rr.ActionExpertGuaranteesBody) (*rr.RawResponse, *ResponseMeta, error) {
...
func (s *CurrenciesService) List(ctx context.Context, opts *rr.ListCurrenciesOptions) (*rr.ListCurrenciesResponse, *ResponseMeta, error) {
...
func (s *CategoriesService) List(ctx context.Context, opts *rr.ListCategoriesOptions) (*rr.ListCategoriesResponse, *ResponseMeta, error) {
...
func (s *BudgetsService) List(ctx context.Context, opts *rr.ListBudgetsOptions) (*rr.ListBudgetsResponse, *ResponseMeta, error) {
