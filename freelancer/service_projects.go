...
func (s *ProjectsService) Create(ctx context.Context, b utils.CreateProjectBody) (*CreateProjectResponse, error) {
...
func (s *ProjectsService) List(ctx context.Context, opts *utils.ListProjectsOptions) (*ListProjectsResponse, error) {
	p := endpoints.Projects
	q := query.Values(opts)
...
func (s *ProjectsService) ListSelf(ctx context.Context, opts *utils.ListSelfProjectsOptions) (*ListProjectsResponse, error) {
...
func (s *ProjectsService) Get(ctx context.Context, projectID int64, opts *utils.GetProjectOptions) (*GetProjectResponse, error) {
	p := fmt.Sprintf("%s/%d", endpoints.Projects, projectID)
	q := query.Values(opts)
...
func (s *ProjectsService) SearchActive(ctx context.Context, opts *utils.SearchActiveProjectsOptions) (*ListProjectsResponse, error) {
...
func (s *ProjectsService) SearchAll(ctx context.Context, opts *utils.SearchAllProjectsOptions) (*ListProjectsResponse, error) {
...
func (s *ProjectsService) InviteFreelancer(ctx context.Context, projectID int64, b utils.InviteFreelancersBody) (*RawResponse, error) {
...
func (s *ProjectsService) ListUpgradesFees(ctx context.Context, opts *utils.ListUpgradesFeesOptions) (*RawResponse, error) {
...
func (s *ProjectsService) ListBids(ctx context.Context, projectID int64, opts *utils.ListProjectBidsOptions) (*RawResponse, error) {
...
func (s *ProjectsService) ListMilestones(ctx context.Context, projectID int64, opts *utils.ListProjectMilestonesOptions) (*RawResponse, error) {
...
func (s *ProjectsService) ListMilestoneRequests(ctx context.Context, projectID int64, opts *utils.ListProjectsMilestoneRequestsOptions) (*RawResponse, error) {
...
func (s *ProjectsService) GetHourlyContractInfo(ctx context.Context, opts *utils.GetHourlyContractInfoOptions) (*RawResponse, error) {
...
func (s *CollaborationsService) Create(ctx context.Context, projectID int64, b utils.CreateProjectCollaborationsBody) (*RawResponse, error) {
	p := fmt.Sprintf("%s/%s/collaborations", endpoints.Projects, strconv.FormatInt(projectID, 10))
...
func (s *ServicesService) Order(ctx context.Context, serviceID int, serviceType utils.ServiceType) (*RawResponse, error) {
...
func (s *ServicesService) List(ctx context.Context, opts *utils.ListServicesOptions) (*RawResponse, error) {
...
func (s *ServicesService) SearchActive(ctx context.Context, opts *utils.SearchActiveServicesOptions) (*RawResponse, error) {
...
func (s *BidsService) List(ctx context.Context, opts *utils.ListBidsOptions) (*RawResponse, error) {
...
func (s *BidsService) Get(ctx context.Context, bidID int64, opts *utils.GetBidOptions) (*RawResponse, error) {
...
func (s *BidsService) Create(ctx context.Context, b utils.CreateBidBody) (*RawResponse, error) {
	p := endpoints.ProjectsBids
	return execute[*RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
// It maps to the `PUT` `/projects/0.1/bids/{bid_id}` endpoint
func (s *BidsService) Update(ctx context.Context, bidID int64, b utils.UpdateBidBody) (*RawResponse, error) {
	p := fmt.Sprintf("%s/%d", endpoints.ProjectsBids, bidID)
	return execute[*RawResponse](ctx, s.client, http.MethodPut, p, nil, b)
}
...
func (s *BidsService) GetTimeTracking(ctx context.Context, bidID int64, opts *utils.GetTimeTrackingOptions) (*RawResponse, error) {
...
func (s *BidsService) CreateTimeTracking(ctx context.Context, bidID int64, b utils.CreateTimeTrackingBody) (*RawResponse, error) {
	p := fmt.Sprintf("%s/%d/time_tracking", endpoints.ProjectsBids, bidID)
	return execute[*RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *BidEditRequestService) List(ctx context.Context, bidID int64, opts *utils.ListBidEditRequestsOptions) (*ListBidEditRequestsResponse, error) {
...
func (s *BidEditRequestService) Create(ctx context.Context, b utils.CreateBidEditRequestsBody) (*CreateBidEditRequestResponse, error) {
...
func (s *BidEditRequestService) Action(ctx context.Context, bidID, bidEditRequestID int64, b utils.ActionBidEditRequestsBody) (*ActionBidEditRequestResponse, error) {
...
func (s *BidRatingsService) GetByListOfBids(ctx context.Context, opts *utils.GetByListOfBidsOptions) (*RawResponse, error) {
...
func (s *BidRatingsService) Create(ctx context.Context, bidID int64, b utils.CreateBidRatingsBody) (*RawResponse, error) {
	p := fmt.Sprintf("%s/%d/bid_ratings", endpoints.ProjectsBids, bidID)
	return execute[*RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *BidRatingsService) Update(ctx context.Context, bidID int64, bidRatingId int64, b utils.UpdateBidRatingBody) (*RawResponse, error) {
...
func (s *JobsService) List(ctx context.Context, opts *utils.ListJobsOptions) (*RawResponse, error) {
...
func (s *JobsService) Search(ctx context.Context, opts *utils.SearchJobsOptions) (*RawResponse, error) {
...
func (s *JobsService) ListJobBundles(ctx context.Context, opts *utils.ListJobBundlesOptions) (*RawResponse, error) {
...
func (s *JobsService) ListJobBundleCategories(ctx context.Context, opts *utils.ListJobBundleCategoriesOptions) (*RawResponse, error) {
...
func (s *MilestonesService) List(ctx context.Context, opts *utils.ListMilestonesOptions) (*RawResponse, error) {
...
func (s *MilestonesService) GetByID(ctx context.Context, milestoneID int, opts *utils.GetMilestoneOptions) (*RawResponse, error) {
...
func (s *MilestonesService) Create(ctx context.Context, b utils.CreateMilestoneBody) (*RawResponse, error) {
	p := endpoints.ProjectsMilestones
	return execute[*RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *MilestonesService) Action(ctx context.Context, milestoneID int, b utils.ActionMilestoneBody) (*RawResponse, error) {
	p := fmt.Sprintf("%s/%d", endpoints.ProjectsMilestones, milestoneID)
	return execute[*RawResponse](ctx, s.client, http.MethodPut, p, nil, b)
}
...
func (s *MilestoneRequestsService) List(ctx context.Context, opts *utils.ListMilestonesRequestsOptions) (*RawResponse, error) {
...
func (s *MilestoneRequestsService) Get(ctx context.Context, milestoneRequestID int, opts *utils.GetMilestoneRequestOptions) (*RawResponse, error) {
...
func (s *MilestoneRequestsService) Create(ctx context.Context, b utils.CreateMilestoneRequestBody) (*RawResponse, error) {
	p := endpoints.ProjectsMilestoneRequests
	return execute[*RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *MilestoneRequestsService) Action(ctx context.Context, milestoneRequestID int, b utils.ActionMilestoneRequestBody) (*RawResponse, error) {
	p := fmt.Sprintf("%s/%d", endpoints.ProjectsMilestoneRequests, milestoneRequestID)
	return execute[*RawResponse](ctx, s.client, http.MethodPut, p, nil, b)
}
...
func (s *ReviewsService) List(ctx context.Context, opts *utils.ListReviewsOptions) (*RawResponse, error) {
...
func (s *ReviewsService) Create(ctx context.Context, b utils.CreateReviewBody) (*RawResponse, error) {
	p := endpoints.ProjectsReviews
	return execute[*RawResponse](ctx, s.client, http.MethodPost, p, nil, b)
}
...
func (s *ReviewsService) Action(ctx context.Context, reviewID int64, b utils.ReviewActionBody) (*RawResponse, error) {
...
func (s *ExpertGuaranteesService) List(ctx context.Context, opts *utils.ListExpertGuaranteesOptions) (*RawResponse, error) {
...
func (s *ExpertGuaranteesService) Action(ctx context.Context, expertGuaranteesID int64, b utils.ExpertGuaranteesActionRequestBody) (*RawResponse, error) {
...
func (s *CurrenciesService) List(ctx context.Context, opts *utils.ListCurrenciesOptions) (*ListCurrenciesResponse, error) {
...
func (s *CategoriesService) List(ctx context.Context, opts *utils.ListCategoriesOptions) (*ListCategoriesResponse, error) {
...
func (s *BudgetsService) List(ctx context.Context, opts *utils.ListBudgetsOptions) (*ListBudgetsResponse, error) {
